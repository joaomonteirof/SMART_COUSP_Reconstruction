...
def test_model(encoder, decoder, data_loader, n_tests, cuda_mode):
	...
	for i in range(n_tests):
		...
		out, context = encoder.forward(sample_in)

		sample_rec = decoder.forward(out, context).cpu()
...
if __name__ == '__main__':
	...
	test_model(encoder, decoder, data_loader=data_set, n_tests=args.n_tests, cuda_mode=args.cuda)
